...
我的个人博客：[https://poplpr.github.io](https://poplpr.github.io)，欢迎 Star 和 Fork。
...
**[在线预览 &rarr;](https://poplpr.github.io)**
...
- \_posts 文件夹中的 blog 要按照 `日期-题目.md` 的格式如 `2024-06-23-zsh-shell.md` 来完成。然后windows 的行尾序列可能搞成了 CRLF，必须设置成 LF 才是正确的格式。
...
本博客外观基于 [DONGChuan](https://dongchuan.github.io) 以及 [mzlogin](https://mazhuang.org) 修改，感谢！
